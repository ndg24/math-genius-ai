...
class DecimalTest(absltest.TestCase):
  ...
  def testStr(self):
    ...
    self.assertEqual(str(display.Decimal(sympy.Rational(20171, 1000000))), '0.020171')
...
class StringNumberTest(absltest.TestCase):
  ...
  def testIntegerToWords(self):
    ...
    self.assertEqual(str(words), 'fifteen-million-four-hundred-and-thirty-nine-thousand-eight-hundred-and-twenty-two')
